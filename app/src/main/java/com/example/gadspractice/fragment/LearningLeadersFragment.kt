package com.example.gadspractice.fragment
...
import com.example.gadspractice.adapter.CustomAdapter
import com.example.gadspractice.api.ApiService
...
class LearningLeadersFragment : Fragment(R.layout.fragment_learning) {
    ...
    private fun showData(userInfo: List<UserInfo>) {
        val adapter = CustomAdapter(userInfo, R.drawable.learner)
